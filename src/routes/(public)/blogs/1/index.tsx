      ...
      {/* {blogData ? ( */}
        <>
          <div class="mt-4 rounded-4xl border bg-white p-4 shadow-md">
            ...
            <img
              src={blog.value[blogId.value-1].imageUrl}
              alt={blog.value[blogId.value-1].title}
            ...
            <div class="mt-[-10px] flex w-full flex-col gap-2 rounded-3xl border border-emerald-400 bg-emerald-50 px-4 py-8">
              <p class="text-sm text-emerald-500">{blog.value[blogId.value-1].date}</p>
              <div class="mt-2 flex flex-row gap-2">
                {blog.value[blogId.value-1].tags.split(",").map((tag, index) => (
              ...
              <p class="text-sm text-emerald-500">
                Author: {blog.value[blogId.value-1].author}
              </p>
              <h2 class="mt-2 text-xl font-semibold">{blog.value[blogId.value-1].title}</h2>
              <p class="mt-2 text-sm text-black">{blog.value[blogId.value-1].content}</p>
            </div>
          </div>
          {blogId.value !== 1 && (
            <button
          ...
          {Number(blogId.value) !== blog.value[blogId.value-1].count && (
            <button
